...
export class SavingsController {
    ...
    async getAllGoals(c) {
        ...
        try {
            ...
            logger.error(`获取储蓄目标列表失败`, error, { userId: user.userId });
    ...
    async createGoal(c) {
        ...
        try {
            ...
            logger.error(`创建储蓄目标失败`, error, { userId: user.userId });
    ...
    async updateGoal(c) {
        ...
        try {
            ...
            logger.error(`更新储蓄目标失败`, error, { userId: user.userId, goalId });
    ...
    async deleteGoal(c) {
        ...
        try {
            ...
            logger.error(`删除储蓄目标失败`, error, { userId: user.userId, goalId });
    ...
    async deposit(c) {
        ...
        try {
            ...
            logger.error(`存款失败`, error, { userId: user.userId, goalId });
    ...
    async withdraw(c) {
        ...
        try {
            ...
            logger.error(`取款失败`, error, { userId: user.userId, goalId });
    ...
    async getSummary(c) {
        ...
        try {
            ...
            logger.error(`获取储蓄统计失败`, error, { userId: user.userId });
