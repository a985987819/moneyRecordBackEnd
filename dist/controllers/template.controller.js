...
export class TemplateController {
    ...
    async getAllTemplates(c) {
        ...
        try {
            ...
            logger.error(`获取模板列表失败`, error, { userId: user.userId });
    ...
    async createTemplate(c) {
        ...
        try {
            ...
            logger.error(`创建模板失败`, error, { userId: user.userId });
    ...
    async updateTemplate(c) {
        ...
        try {
            ...
            logger.error(`更新模板失败`, error, { userId: user.userId, id });
    ...
    async deleteTemplate(c) {
        ...
        try {
            ...
            logger.error(`删除模板失败`, error, { userId: user.userId, id });
    ...
    async useTemplate(c) {
        ...
        try {
            ...
            logger.error(`使用模板创建记录失败`, error, { userId: user.userId, templateId: id });
