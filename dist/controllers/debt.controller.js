...
export class DebtController {
    ...
    async getAllDebts(c) {
        ...
        try {
            ...
            logger.error(`获取借贷列表失败`, error, { userId: user.userId });
    ...
    async createDebt(c) {
        ...
        try {
            ...
            logger.error(`创建借贷记录失败`, error, { userId: user.userId });
    ...
    async updateDebt(c) {
        ...
        try {
            ...
            logger.error(`更新借贷记录失败`, error, { userId: user.userId, id });
    ...
    async deleteDebt(c) {
        ...
        try {
            ...
            logger.error(`删除借贷记录失败`, error, { userId: user.userId, id });
    ...
    async repay(c) {
        ...
        try {
            ...
            logger.error(`还款失败`, error, { userId: user.userId, id });
    ...
    async getSummary(c) {
        ...
        try {
            ...
            logger.error(`获取借贷统计失败`, error, { userId: user.userId });
